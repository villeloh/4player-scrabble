...
export function initTiles(): Map<number, TileObj> {
  ...
  tiles.set(id, new TileObj(id, 'WSx3'));
  tiles.set(++id, new TileObj(id));
  tiles.set(++id, new TileObj(id));
  tiles.set(++id, new TileObj(id, 'LSx2'));
  tiles.set(++id, new TileObj(id));
  tiles.set(++id, new TileObj(id));
  tiles.set(++id, new TileObj(id));
  tiles.set(++id, new TileObj(id, 'WSx3'));
  ...
  tiles.set(++id, new TileObj(id));
  tiles.set(++id, new TileObj(id, 'WSx2'));
  tiles.set(++id, new TileObj(id));
  tiles.set(++id, new TileObj(id));
  tiles.set(++id, new TileObj(id));
  tiles.set(++id, new TileObj(id, 'LSx3'));
  tiles.set(++id, new TileObj(id));
  tiles.set(++id, new TileObj(id));
  tiles.set(++id, new TileObj(id));
  tiles.set(++id, new TileObj(id, 'LSx3'));
  ...
  tiles.set(++id, new TileObj(id));
  tiles.set(++id, new TileObj(id));
  tiles.set(++id, new TileObj(id, 'CENTER'));
  tiles.set(++id, new TileObj(id));
  tiles.set(++id, new TileObj(id));
  tiles.set(++id, new TileObj(id));
  tiles.set(++id, new TileObj(id, 'LSx2'));
